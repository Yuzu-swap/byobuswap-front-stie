...
import { Currency, ETHER, Token, currencyEquals } from '@liuxingfeiyu/byobu-sdk'
...
export function useCurrency(currencyId: string | undefined): Currency | null | undefined {
  ...
  const isNative = currencyId?.toUpperCase() === nativeToken.getSymbol(DefaultChainId)?.toUpperCase()
  const token = useToken(isNative ? undefined : currencyId)
  return isNative ? nativeToken : token
