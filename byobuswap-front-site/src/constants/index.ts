import { ChainId, JSBI, Percent, Token, WETH ,SUSHI_ADDRESS,DefaultChainToken} from '@liuxingfeiyu/byobu-sdk'
...
const WRAPPED_NATIVE_ONLY: ChainTokenList = {
  ...
  [ChainId.OASISETH_SAPPHIRE_TEST]: [WETH[ChainId.OASISETH_SAPPHIRE_TEST]],
}
