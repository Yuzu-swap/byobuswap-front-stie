import { CurrencyAmount, JSBI, Token, Trade } from '@liuxingfeiyu/byobu-sdk'
...
export default function Swap() {
  ...
  return (
    <>
      ...
      <AppBody>
        {/* <SwapHeader /> */}
        <Wrapper id="swap-page" style={{background: '#191B25', borderRadius: '8px 8px 0 0', borderBottom:'1px solid rgba(255, 255, 255, 0.2)'}}>
          <ConfirmSwapModal
            isOpen={showConfirm}
            trade={trade}
        ...
        <Wrapper  style={{background: '#191B25', borderRadius: '0 0 8px 8px ' }}>
          <AutoColumn>
            {showWrap ? null : (
