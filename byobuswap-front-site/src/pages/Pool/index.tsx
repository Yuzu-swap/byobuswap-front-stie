...
import { Pair, JSBI } from '@liuxingfeiyu/byobu-sdk'
...
const ResponsiveButtonPrimary = styled(ButtonPrimaryNormal)`
  ...
  ${({ theme }) => theme.mediaWidth.upToSmall`
    width: 48%;
  `};
  background: linear-gradient(90deg, #01B3AE 0%, #00969D 100%);
`
  ...
  return (
    <>
      ...
      <PageWrapper>
        ...
        <VoteCard style={{  padding: '1rem 0', borderRadius: '8px 8px 0 0'}}>
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.bg7 fontSize={20} fontWeight={600}>
        ...
        <AutoColumn gap="md" justify="center" style={{ backgroundColor: '#1D202B', borderRadius: '0 0 8px 8px' }}>
          <AutoColumn gap="md" style={{ width: '100%' }}>
            <TitleRow style={{ padding: '1rem 1rem'}}>
              <HideSmall>
                <TYPE.bg7 fontSize={20} style={{ justifySelf: 'flex-start' }}>
            ...
            {!account ? (
              ...
              <EmptyProposals style={{ background: '#F1F1F1', border: '1px solid #10A6BF', borderRadius: '8px', margin: '20px' }}>
                <TYPE.body color={theme.text3} textAlign="center">
                  <Dots>{t('loading')}</Dots>
                </TYPE.body>
              </EmptyProposals>
