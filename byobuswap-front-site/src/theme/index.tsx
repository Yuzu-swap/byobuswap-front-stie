...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    bg6: darkMode ? '#10A6BF' : '#10A6BF',
    bg7: darkMode ? '#CCDBE5' : '#CCDBE5',
    bg8: darkMode ? '#222529' : '#222529',
    bg9: darkMode ? '#2C3035' : '#2C3035',
    bg10: darkMode ? '#191B25' : '#191B25',
    ...
    //primary colors
    primary1: darkMode ? '#10A6BF' : '#10A6BF',
    primary2: darkMode ? '#0097fb' : '#FF8CC3',
    primary3: darkMode ? '#10A6BF' : '#10A6BF',
    primary4: darkMode ? '#376bad70' : '#F6DDE8',
    primary5: darkMode ? '#153d6f70' : '#ebebeb',

    // color text
    primaryText1: darkMode ? '#10A6BF' : '#10A6BF',
