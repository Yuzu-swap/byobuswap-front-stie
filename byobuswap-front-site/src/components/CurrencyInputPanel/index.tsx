import { Currency, Pair } from '@liuxingfeiyu/byobu-sdk'
...
const CurrencySelect = styled.button<{ selected: boolean }>`
  ...
  font-size: 20px;
  font-weight: 500;
  background: ${({ selected, theme }) => (selected ? theme.bg7 : 'linear-gradient(135deg, #4661D9 0%, #9B3CD1 100%)')};
  ...
  :focus,
  :hover {
    background-color: ${({ selected, theme }) => (selected ? darken(0.05,theme.bg7) : darken(0.05, theme.primary1))};
  }
`
