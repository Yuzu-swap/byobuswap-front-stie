...
export const ButtonPrimary = styled(Base)`
  ...
  overflow:hidden;
  background: linear-gradient(135deg, #4661D9 0%, #9B3CD1 100%);
...
export const ButtonUnderLine = styled(Base)<{active : boolean}>`
  ...
  ${({active})=>(
    ...
    `
      color: #10A6BF;
      border-bottom: 4px solid #10A6BF;
    `
    :``
  )
...
export const ButtonXyuzuCard = styled(Base)`
  ...
  &:hover {
    background-color: darken(0.05,linear-gradient(90deg, #01B3AE 0%, #00969D 100%));
  }
  &:disabled{
