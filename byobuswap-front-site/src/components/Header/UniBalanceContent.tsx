import { ChainId, TokenAmount } from '@liuxingfeiyu/byobu-sdk'
import React, { useMemo } from 'react'
import { X } from 'react-feather'
import styled from 'styled-components'
import tokenLogo from '../../assets/svg/yuzuwhitelogo.svg'
  ...
  return (
    <ContentWrapper gap="lg">
      <ModalUpper>
        <CardSection gap="md">
          <RowBetween>
            <TYPE.white color="white">Your YUZU Breakdown</TYPE.white>
        ...
        <CardSection gap="sm">
          <AutoColumn gap="md">
            <RowBetween>
              <TYPE.white color="white">YUZU price:</TYPE.white>
              <TYPE.white color="white">${zooPrice != 0 ?fixFloat(zooPrice, 3) : '-'}</TYPE.white>
            </RowBetween>
            {/* <RowBetween>
