import { ChainId, TokenAmount, Currency } from '@liuxingfeiyu/byobu-sdk'
...
const NETWORK_LABELS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.OASISETH_SAPPHIRE]: 'SappHire Mainnet',
  [ChainId.OASISETH_SAPPHIRE_TEST]: 'SappHire Testnet'
}
...
export const CHAIN_CONFIG = {
  ...
  [ChainId.OASISETH_SAPPHIRE_TEST]: {
    ChainId: '0x5aff',
    rpcUrl: RPC[ChainId.OASISETH_SAPPHIRE_TEST],
    chainName: NETWORK_LABELS[ChainId.OASISETH_SAPPHIRE_TEST]||'',
...
export default function Header() {
  ...
  const isMainNet:boolean = useMemo(
    ()=>{
      return chainId && chainId == ChainId.OASISETH_SAPPHIRE_TEST ? true : false
    }
    ,
    [chainId]
  )
