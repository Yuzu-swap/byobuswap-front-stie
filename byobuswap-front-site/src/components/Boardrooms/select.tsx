...
import { ChainId, CurrencyAmount, JSBI, Token, TokenAmount, StakePool, Currency } from '@liuxingfeiyu/byobu-sdk'
...
import QuestionHelper, {AddQuestionHelper, AddQuestionNoCHelper, LightQuestionHelper} from 'components/QuestionHelper'
    ...
    btn = (<div className="s-boardroom-stake-inline">
      {
        ...
        :
        <div className="s-xyuzu-tab-wrapper">
          <div className="s-boardroom-select s-boardroom-stake-button s-boardroom-unwrap-button" onClick={async () => { setShowConfirmation(true); }}>{t('pledge')} LP <QuestionHelper text={t('pledgeTip')} /></div>
        </div>
      }
