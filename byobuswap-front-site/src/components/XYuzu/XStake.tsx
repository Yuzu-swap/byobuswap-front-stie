...
import { ChainId, CurrencyAmount, JSBI, Token, TokenAmount, StakePool, AttenuationReward, ROUTER_ADDRESS, ZOO_ZAP_ADDRESS, Pair, Currency, WETH } from '@liuxingfeiyu/byobu-sdk'
...
export function XStake(){
    ...
    const CurrencySelect = styled.button<{ selected: boolean }>`
        ...
        font-size: 20px;
        font-weight: 500;
        background: ${({ selected, theme }) => (selected ? theme.bg7 : 'linear-gradient(177deg, #10A6BF 0%, #F98F81 100%)')};
