        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        envelope = _a.sent();
                        return [2 /*return*/, envelope ? hexlify(cbor.encode(envelope)) : ''];
                }
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.encryptCallData(arrayify(plaintext))];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = hexlify;
                        return [4 /*yield*/, this.decryptCallResult(cbor.decode(arrayify(callResult)))];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (res.ok)
                            return [2 /*return*/, arrayify(res.ok)];
                        if (res.fail)
                            throw new CallError(formatFailure(res.fail), fail);
                    ...
                    case 1:
                        ...
                        if (inner.ok)
                            return [2 /*return*/, arrayify(inner.ok)];
                        if (inner.fail)
                            throw new CallError(formatFailure(inner.fail), inner.fail);
                        throw new CallError("Unexpected inner call result: ".concat(JSON.stringify(inner)), inner);
                    case 2: throw new CallError("Unexpected call result: ".concat(JSON.stringify(res)), res);
                }
            });
        });
    };
...
var X25519DeoxysII = /** @class */ (function (_super) {
    ...
    X25519DeoxysII.fromSecretKey = function (secretKey, peerPublicKey) {
        var keypair = nacl.box.keyPair.fromSecretKey(arrayify(secretKey));
    ...
    X25519DeoxysII.prototype.encrypt = function (plaintext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                nonce = nacl.randomBytes(deoxysii.NonceSize);
...
export function fetchRuntimePublicKey(source, opts) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 2:
                    if ('gatewayUrl' in source) {
                        ...
                        (gatewayUrl = NETWORKS[chainId].defaultGateway);
                        if (!gatewayUrl)
                ...
                case 3:
                    res = _b.sent();
                    return [2 /*return*/, arrayify(res.result.key)];
            }
        });
    });
}
function fetchRuntimePublicKeyNode(gwUrl) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, import(/* webpackIgnore: true */ 'https')];
                case 1:
                    https = _a.sent();
