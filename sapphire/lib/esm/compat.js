...
import { Kind as CipherKind, X25519DeoxysII, fetchRuntimePublicKey, lazy as lazyCipher, } from './cipher.js';
...
export function wrap(upstream, customCipher) {
    ...
    if (typeof upstream === 'string') {
        var provider = new JsonRpcProvider(upstream);
...
function getCipher(provider) {
    var _this = this;
    return lazyCipher(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    keySource = _a.sent();
                    return [4 /*yield*/, fetchRuntimePublicKey(keySource)];
                case 2:
                    rtPubKey = _a.sent();
                    return [2 /*return*/, X25519DeoxysII.ephemeral(rtPubKey)];
            }
        });
    }); });
}
            ...
            switch (_b.label) {
                case 0:
                    if (args.method === 'eth_estimateGas')
                        return [2 /*return*/, BigNumber.from(DEFAULT_GAS).toHexString()]; // TODO(#39)
...
function prepareSignedCall(call, signer, cipher) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, SignedCallDataPack.make(call, signer)];
                case 1:
                    dataPack = _c.sent();
                    _a = [__assign({}, call)];
                    _b = {};
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    ...
                    data = arrayify(txFields[DATA_FIELD], { allowMissingPrefix: true });
                    try {
                    ...
                    _d = parseTx(raw), r = _d.r, s = _d.s, v = _d.v, hash = _d.hash, type = _d.type, parsed = __rest(_d, ["r", "s", "v", "hash", "type"]);
                    if (!signer)
                        throw new CallError(REPACK_ERROR, null);
                    if (!parsed.gasLimit)
                        parsed.gasLimit = BigNumber.from(DEFAULT_GAS); // TODO(39)
                    _j.label = 1;
                case 1:
                    _j.trys.push([1, 3, , 4]);
                ...
                case 3:
                    e_1 = _j.sent();
                    throw new CallError(REPACK_ERROR, e_1);
